...
async function showMainMenu(ctx) {
  ...
  try {
    ...
    if (ctx.session?.mainMenuMessageId) {
      ...
      const message = await ctx.reply(caption, { 
        parse_mode: 'Markdown', 
        ...keyboard 
      });
...
// Создание сделки с ИНЛАЙН КНОПКАМИ
...
// Вывод средств с ИНЛАЙН КНОПКАМИ
